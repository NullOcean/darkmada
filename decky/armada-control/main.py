...
class Plugin:
    ...
    async def set_rgb(self, enabled, link_brightness, color, max_brightness, brightness):
        return await asyncio.to_thread(set_rgb, enabled, link_brightness, color, max_brightness, brightness)
